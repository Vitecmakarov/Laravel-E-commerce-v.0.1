        ...
        <div class="container">
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        <p class="font-italic mb-4">If you have a Coupon code, enter it in the field below</p>
                    <form action="{{ route('cart.store.coupon') }}" method="POST">
                        @csrf
                        <div class="input-group mb-4 border rounded-pill p-2">
                            <input type="text" placeholder="Enter your code here" name="code" aria-describedby="button-addon3" class="form-control border-0">
                    ...
                    @else
                    <div class="p-4">
                        <p class="font-italic mb-4">A coupon is already applied</p>
                    </div>
                    @endif
                    <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Instructions for the seller</div>
                    <div class="p-4">
                        <p class="font-italic mb-4">If you wish to add details to your order, please enter them in the field below</p>
                        <textarea name="" cols="30" rows="2" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Order details
                    </div>
                    <div class="p-4">
                        <p class="font-italic mb-4">Any delivery costs will be calculated according to the information you have provided</p>
                        <ul class="list-unstyled mb-4">
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Subtotal </strong><strong>{{ getPrice(Cart::subtotal()) }}</strong></li>
                        @if (request()->session()->has('coupon'))
                        ...
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">New Subtotal</strong><strong>
                        ...
                        @endif
                        </ul><a href="{{ route('checkout.index') }}" class="btn btn-dark rounded-pill py-2 btn-block"><i class="fa fa-credit-card" aria-hidden="true"></i>Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>
...
@else
<div class="col-md-12">
    <h5>Your cart is empty at the moment</h5>
    <p>But you can visit the <a href="{{ route('products.index') }}">boutique</a> to do your shopping.
    </p>
</div>
@endif
